...
int main(int argc, char *argv[])
{
    ...
    if(file_buf[ELF_CLAS_IDX] == ELF32){
        ...
        print_elf32_sym(file_buf, elf32_ehdr->e_shoff, elf32_ehdr->e_shnum, elf32_ehdr->e_shstrndx);
        ...
        print_elf64_sym(file_buf, elf64_ehdr->e_shoff, elf64_ehdr->e_shnum, elf64_ehdr->e_shstrndx);
    }
exit:
    if(file_buf){
        free(file_buf);
